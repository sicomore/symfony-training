...
//            $messageLog = 'A new user was created.';
...
//            $dispatcher->dispatch($event, DoctrineLogEvent::NAME);
     ...
     */
    public function show(Utilisateur $utilisateur, PronosticRepository $pronosticRepository): Response
    {
        $userPronostics = $pronosticRepository->getPronoByUserGroupedByMatch($utilisateur);

        return $this->render('utilisateur/show.html.twig', [
            'utilisateur' => $utilisateur,
            'pronostics' => $userPronostics,
        ]);
    }
