...
class Game
{
    ...
    public function getLastPronostic(): ?\DateTimeInterface
    {
        return $this->lastPronostic;
    }

    public function setLastPronostic(?\DateTimeInterface $lastPronostic): self
    {
        $this->lastPronostic = $lastPronostic;
